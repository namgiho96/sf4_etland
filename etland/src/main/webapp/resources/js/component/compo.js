	...
	prod_post : ()=>{
			return '<div class="col-md-8 order-md-1">'
              ...
              +'<div class="col-md-5 mb-3">'
                ...
                +'<select id="category_name" class="custom-select d-block w-100" required="">'
              ...
              +'</div>'
	            +'<hr class="mb-4">'
	            +'<div class="mb-3">'
	              +'<label for="product_name">상품명 <span class="text-muted"></span></label>'
	            ...
	            +'<div class="mb-3">'
	              ...
	              +'<input type="text" id="price" class="form-control"가격(만원단위)">'
	            ...
	            +'<div class="row">'
	              +'<div class="col-md-5 mb-3">'
	                +'<label for="supplier_name">공급업체</label>'
	                +'<select id="supplier_name" class="custom-select d-block w-100" required="">'
	                  +'<option value="">업체선정</option>'
	                  +'<option value="삼성">삼 성</option>'
	                  +'<option value="엘지">LG전자</option>'
	            ...
	            +'<div class="d-block my-3">'
	              ...
	              +'  <input id="credit" name="color" type="radio" class="custom-control-input" checked="" value="화이트" required="">'
	                +'<label class="radi custom-control-label" for="credit" >화이트</label>'
	              +'</div>'
	              +'<div class="custom-control custom-radio">'
	                +'<input id="debit" name="color" type="radio" class="custom-control-input" value="블랙" required="">'
	                +'<label class="radi custom-control-label" for="debit" >블랙</label>'
	              +'</div>'
	              +'<div class="custom-control custom-radio">'
	                +'<input id="paypal" name="color" type="radio" class="custom-control-input" value="블루" required="">'
	            ...
	            +'<div class="row">'
	              ...
	              +'<form id="img_drag">'
	                ...
	                +'<div class="invalid-feedback">'
	                +'</div>'
	              +'<input type="submit" id="img_drag_btn" encType="multipart/form-data">'
	              +'</form>'
	              +'</div>'
	            +'</div>'
	            +'<hr class="mb-4">'
